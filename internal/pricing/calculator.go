...
func (c *Calculator) GetPluginInfo(ctx context.Context, req *finfocusv1.GetPluginInfoRequest) (*finfocusv1.GetPluginInfoResponse, error) {
...
func (c *Calculator) EstimateCost(ctx context.Context, req *finfocusv1.EstimateCostRequest) (*finfocusv1.EstimateCostResponse, error) {
