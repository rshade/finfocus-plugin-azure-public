...
func TestNormalizeDiskType(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input:      "StandardSSD_LRS",
			wantSKU:    "StandardSSD_LRS",
			wantPrefix: "E",
			wantRedund: "LRS",
		},
		{
			name:       "Premium_SSD_LRS",
			input:      "Premium_SSD_LRS",
			wantSKU:    "Premium_LRS",
			wantPrefix: "P",
			wantRedund: "LRS",
		},
		{
			name:       "Standard_ZRS",
			input:      "Standard_ZRS",
			wantSKU:    "Standard_ZRS",
			wantPrefix: "S",
			wantRedund: "ZRS",
		},
		{
			name:       "StandardSSD_ZRS",
			input:      "StandardSSD_ZRS",
			wantSKU:    "StandardSSD_ZRS",
			wantPrefix: "E",
			wantRedund: "ZRS",
		},
		{
